 ...
 *
 *      All Parsing methods were written by Mike Schrenk in his book Webbots Spiders and Screenscrapers, the original
 *      source is available at http://www.schrenk.com/nostarch/webbots/DSP_download.php
 */
...
class HTTPBot
{
     ...
     *
     *      Will Create an instance of webBot, initializes the cookie file, any proxy settings, as well as generating a
     ...
     *
     * @param array $nodes - Contains an array of arrays, each subarray contains at least one URL and an optional set
     *                       of POST parameters to send (default: $this->urls)
     *
     * @return array
     */
    public function curlMultiRequest($nodes = null)
    {
