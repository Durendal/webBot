<?php
/**
 *      Parser.php - Parsing subroutines adapted from Mike Schrenks LIB_PARSE.php
 *      in Webbots spiders and screenscrapers http://webbotsspidersscreenscrapers.com/
 *
...
class Parser
{
     ...
     *
     *      Returns the portion of a string either before or after a delineator.
     *      The returned string may or may not include the delineator.
     *
     ...
     *
     *      Returns a substring of $string delineated by $start and $stop
     ...
     *      This function is usful for returning an array that contains links,
     *      images, tables or any other data that appears more than once.
     *
